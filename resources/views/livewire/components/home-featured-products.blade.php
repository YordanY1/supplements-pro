    ...
    <div class="max-w-6xl mx-auto text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            @foreach ($products as $product)
                <div class="bg-primary/50 p-6 rounded-2xl border border-white/10 shadow-xl hover:shadow-2xl transition duration-300 text-center">
                    ...
                    <p class="text-xl font-semibold text-white">{{ number_format($product->price, 2) }} лв.</p>
                </div>
            @endforeach
        </div>
